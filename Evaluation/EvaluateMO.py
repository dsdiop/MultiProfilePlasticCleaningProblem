...
if __name__ == '__main__':
    if True:
        ...
        """for n in nu_intervals.keys():
            n='6'"""
        seeds = [17,43,45,3,31]
        data_path1 = f"{data_path}/../Learning/runs/Vehicles_4/SecondPaper/seq_nu_2experiment/{args.map}_{args.benchmark}"
            ...
            for i,policy_name in enumerate(policy_names):
                ...
                for policy_type in policy_types:
                    ...
                    EvaluateMultiagent(number_of_agents=N,
                                    ...
                                    metrics_directory= f'{data_path}/Evaluation/Results/Results_seed_{seed}_nu_steps_dist_field_{args.map}_30keps/{policy_type}_{nu_step}',
